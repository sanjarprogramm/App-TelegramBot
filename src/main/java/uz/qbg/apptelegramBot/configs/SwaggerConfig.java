package uz.qbg.apptelegramBot.configs;
...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    public Docket swaggerUserApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(Predicates.or(RequestHandlerSelectors.basePackage(RestConstants.BASE_PACKAGE.concat(".configs")),
                        RequestHandlerSelectors.basePackage(RestConstants.BASE_PACKAGE.concat(".controllers"))))
